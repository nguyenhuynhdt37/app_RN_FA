...
class Users(Base):
    ...
    __table_args__ = (
        ...
        {'comment': 'Main user table with profile data'}
    )
...
class CategoryTranslations(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(['category_id'], ['categories.id'], ondelete='CASCADE', name='category_translations_category_id_fkey'),
...
class CoinTransactions(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE', name='coin_transactions_user_id_fkey'),
...
class Courses(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(['instructor_id'], ['users.id'], ondelete='SET NULL', name='courses_instructor_id_fkey'),
        ForeignKeyConstraint(['updated_by'], ['users.id'], ondelete='SET NULL', name='courses_updated_by_fkey'),
        ...
        {'comment': 'Course catalog with pricing and analytics'}
    )
...
class InterestTranslations(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['interest_id'], ['interests_reference.id'], ondelete='CASCADE', name='interest_translations_interest_id_fkey'),
...
class OtpLogs(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE', name='otp_logs_user_id_fkey'),
...
class SkillsReference(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['specialization_id'], ['specializations_reference.id'], ondelete='CASCADE', name='skills_reference_specialization_id_fkey'),
...
class SpecializationTranslations(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['specialization_id'], ['specializations_reference.id'], ondelete='CASCADE', name='specialization_translations_specialization_id_fkey'),
...
class TagTranslations(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['tag_id'], ['tags.id'], ondelete='CASCADE', name='tag_translations_tag_id_fkey'),
...
class UserCoins(Users):
    __tablename__ = 'user_coins'
    __table_args__ = (
        ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE', name='user_coins_user_id_fkey'),
...
class UserInterests(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['interest_id'], ['interests_reference.id'], ondelete='CASCADE', name='user_interests_interest_id_fkey'),
        ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE', name='user_interests_user_id_fkey'),
...
class UserRoles(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['assigned_by'], ['users.id'], ondelete='SET NULL', name='user_roles_assigned_by_fkey'),
...
class UserSpecializations(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['specialization_id'], ['specializations_reference.id'], ondelete='CASCADE', name='user_specializations_specialization_id_fkey'),
        ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE', name='user_specializations_user_id_fkey'),
...
class CourseCategories(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['category_id'], ['categories.id'], ondelete='CASCADE', name='course_categories_category_id_fkey'),
        ForeignKeyConstraint(['course_id'], ['courses.id'], ondelete='CASCADE', name='course_categories_course_id_fkey'),
...
class CourseLearningOutcomes(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['course_id'], ['courses.id'], ondelete='CASCADE', name='course_learning_outcomes_course_id_fkey'),
...
class CoursePrerequisites(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['course_id'], ['courses.id'], ondelete='CASCADE', name='course_prerequisites_course_id_fkey'),
...
class CourseTags(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['course_id'], ['courses.id'], ondelete='CASCADE', name='course_tags_course_id_fkey'),
        ForeignKeyConstraint(['tag_id'], ['tags.id'], ondelete='CASCADE', name='course_tags_tag_id_fkey'),
...
class CourseTranslations(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['course_id'], ['courses.id'], ondelete='CASCADE', name='course_translations_course_id_fkey'),
...
class Sections(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['course_id'], ['courses.id'], ondelete='CASCADE', name='sections_course_id_fkey'),
...
class SkillTranslations(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['skill_id'], ['skills_reference.id'], ondelete='CASCADE', name='skill_translations_skill_id_fkey'),
...
class CourseLearningOutcomeTranslations(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['outcome_id'], ['course_learning_outcomes.id'], ondelete='CASCADE', name='course_learning_outcome_translations_outcome_id_fkey'),
...
class CoursePrerequisiteTranslations(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['prerequisite_id'], ['course_prerequisites.id'], ondelete='CASCADE', name='course_prerequisite_translations_prerequisite_id_fkey'),
...
class LearningUnits(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['required_unit_id'], ['learning_units.id'], ondelete='SET NULL', name='learning_units_required_unit_id_fkey'),
        ForeignKeyConstraint(['section_id'], ['sections.id'], ondelete='CASCADE', name='learning_units_section_id_fkey'),
...
class SectionTranslations(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['section_id'], ['sections.id'], ondelete='CASCADE', name='section_translations_section_id_fkey'),
...
class CourseProgress(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['unit_id'], ['learning_units.id'], ondelete='CASCADE', name='course_progress_unit_id_fkey'),
        ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE', name='course_progress_user_id_fkey'),
...
class LearningBlocks(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['unit_id'], ['learning_units.id'], ondelete='CASCADE', name='learning_blocks_unit_id_fkey'),
...
class LearningUnitTranslations(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['unit_id'], ['learning_units.id'], ondelete='CASCADE', name='learning_unit_translations_unit_id_fkey'),
